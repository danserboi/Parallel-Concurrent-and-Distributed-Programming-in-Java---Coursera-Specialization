...
public final class CoarseLists {
    ...
    public static final class CoarseList extends ListSet {
        /*
         * Lock for this class to be used in implementing the
         ...
         * {@inheritDoc}
         *
         * We use a lock to protect against concurrent access.
         */
        @Override
    ...
    public static final class RWCoarseList extends ListSet {
        /*
         * Read-write lock for this class to be used in
         ...
         * {@inheritDoc}
         *
         * We use a read-write lock to protect against concurrent access.
         */
        @Override
        boolean add(final Integer object) {
            try {
