...
public final class StudentAnalytics {
    ...
    /**
     * We compute the average age of all actively enrolled students using
     * parallel streams.
     * @param studentArray Student data for the class.
     * @return Average age of enrolled students
     */
    ...
    /**
     * We compute the most common first name out of all students that are no
    ...
    /**
     * We compute in parallel the number of students who have failed the course who are
